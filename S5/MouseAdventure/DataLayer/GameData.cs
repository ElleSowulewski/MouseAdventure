    ...
    public static class GameData
    {
        ...
        public static Map GameMap()
        {
            ...
            gameMap.Locations.Add
                (new Location()
                {
                    ...
                    A = "Catch your breath.",
                    B = "Let's continue.",
                    DeathMessage = "You decided to take a break to catch your breath. You \nmust of waited too long, a cat wandered into " +
                                   "the room and snatched you out from your hiding place. You were eaten.",
            ...
            gameMap.Locations.Add
                (new Location()
                {
                    ...
                    DeathMessage = "Staying next to the marble wasn't a good idea. The searching \nhand grabbed you and pulled you out from" +
                                   " your \n hiding place. In fear, you bit the hand the hand and it dropped you. \nYou broke your neck from the fall."
                }
                );
            ...
            gameMap.Locations.Add
                (new Location()
                {
                    ...
                    DeathMessage = "As you peered around the kitchen, you were suddenly pounced on \nfrom behind. The cat snuck up on you and" +
                                   "you were caught off guard. It killed you quickly."
                }
                );
            ...
            gameMap.Locations.Add
                (new Location()
                {
                    ...
                    B = "Try it.",
                    DeathMessage = "The cat snuck up on you as you were focused on finding a way to climb up. It pounced and executed you."
                }
                );
        ...
        public static List<GameItem> StandardGameItems()
        {
            return new List<GameItem>()
            {
                ...
                new QuestItem(21, "Shiny \nGem", "A small polished gem, valued heavily by the other mice", "The other mices' pleas run through your head. You need to return this to them.")
            };
        }
